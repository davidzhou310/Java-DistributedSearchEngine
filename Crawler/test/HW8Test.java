...
public class HW8Test extends GenericTest {
  ...
  void runTests(Set<String> tests) throws Exception {
    ...
    if (tests.contains("run-crawler")) {
      System.out.println("Running the crawler on 'crawler'...");
      String arg[] = new String[] {"https://www.reddit.com/", "https://www.yahoo.com/",
              "https://trends.google.com/trends/trendingsearches/daily?geo=US&hl=en-US",
              "https://en.wikipedia.org/wiki/Wikipedia",  "https://www.nytimes.com/", "https://medium.com/",
              "https://www.cnn.com/","https://www.espn.com/", "https://www.dailymail.co.uk/ushome/index.html", "https://www.wikimedia.org/",
              "https://www.bing.com/news", "https://www.msn.com/", "https://www.quora.com/", "https://stackoverflow.com/",
              "https://www.nih.gov/",  "https://www.researchgate.net/", "https://www.sciencedirect.com/", "https://www.fandom.com/",
              "https://www.imdb.com/", "https://www.w3schools.com/"};
      String output = FlameSubmit.submit("localhost:9000", "crawler.jar", "cis5550.jobs.Crawler", arg);
